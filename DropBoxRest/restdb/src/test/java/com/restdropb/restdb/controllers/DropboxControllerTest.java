...
public class DropboxControllerTest {
    ...
    private String token="E1J6QGtMTPgAAAAAAAAAAS4EOHAMJu3_UEJ8CUjXvQLtb_Y9cRdQEeeK2vkTpaDD1";
    private String nameApp="app_test_pqm";
    ...
    void testDelFile(){
        var dbxController=new DropboxController();
        String ret=dbxController.delFile(nameApp, token, "/Test", "test_upl.txt");
